...
usage: /mnt/d/Programme/Entwicklung/GnuCOBOL/gnu-cobol-reportwriter_mergeonly/cobc/.libs/lt-cobc [options]... file...
...
options:
  ...
  -fcallfh=<value>      Call user written EXTFH interface module for I/O
